...
- `TABLE`: The name of the DynamoDB table for storing WebSocket connection details.
...
3. **Retrieve Access Token**:
   ...
   - It queries the DynamoDB table specified by the environment variable `TABLE` to fetch the access token.
...
- **Environment Variable**: Set the environment variable `TABLE` to the name of your DynamoDB table that stores connection information.

### Steps

1. **Setup Environment**:
   - Ensure that Python and Boto3 are installed in your environment.
   - Set the `TABLE` environment variable to point to your DynamoDB table.
