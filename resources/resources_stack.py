    ...
    def __init__(
        ...
        **kwargs
        ...
        if create_connections_table:
            ...
            print(f"🆕 Creating connections table: {connections_table_name}")
        else:
            # Import existing connections table
            self.connections_table = dynamodb.Table.from_table_name(
                self, "ImportedConnectionsTable", connections_table_name
            )
            print(f"📥 Importing existing connections table: {connections_table_name}")
